...
from helping import views
from django.conf import settings
from django.conf.urls.static import static
from django.contrib.auth import views as auth_views
from helping.forms import MyPasswordResetForm,MySetPasswordForm
...
urlpatterns = [
    ...
    path('passord-reset/done/',auth_views.PasswordResetView.as_view(template_name='password_reset_done.html',
